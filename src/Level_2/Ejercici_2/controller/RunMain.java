...
import Level_2.Ejercici_1.model.data.RestaurantInstances;
...
import static Level_2.Ejercici_1.Main.restaurants;
...
public class RunMain {
    ...
    public static void run() {
        ...
        List<Restaurant> restaurants = new ArrayList<>(Level_2.Ejercici_1.Main.restaurants);
